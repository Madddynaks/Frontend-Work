      ...
      <div className="bg-white rounded-lg p-6 w-[780px]">
        ...
        <div className="flex max-lg:flex-col gap-14 max-lg:gap-5">
          <div className="mt-4 w-1/2 max-lg:w-full">
            ...
            <div className="mt-10 text-center font-semibold"><button>Forgot Password ?</button></div>
          </div>
          <div className="mt-3 w-1/2 max-lg:w-full">
            <div className="text-center">Don't have an account?</div>
            <img className=" max-lg:hidden" src={img} alt="" />
            <div className="text-sm text-gray-500 mt-0">By signing up, you agree to our Terms & conditions,<button className="font-bold">Privacy Policy</button></div>
          </div>
        </div>
      </div>
    </div>
